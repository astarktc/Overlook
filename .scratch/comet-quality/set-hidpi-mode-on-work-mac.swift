...
guard let target = modes.first(where: { $0.width == 2560 && $0.height == 1440 && Int($0.refreshRate) == 60 && $0.pixelWidth == 5120 && $0.isUsableForDesktopGUI() }) else {
...
print(err == .success ? "switched to 2560x1440 HiDPI (5120x2880 framebuffer), saved permanently" : "failed: \(err.rawValue)")
